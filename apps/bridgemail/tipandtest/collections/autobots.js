...
define(['backbone', 'app','tipandtest/models/autobot'], function (Backbone, app,ModelAutoBot) {
	'use strict';
	return Backbone.Collection.extend({
           urlRoot: '/pms/io/trigger/getAutobotData/',
           initialize: function(models,options) {
            ...
            model:ModelAutoBot,
            url: function () {
                return '/pms/io/trigger/getAutobotData/?BMS_REQ_TK=' + app.get('bms_token');
            },
