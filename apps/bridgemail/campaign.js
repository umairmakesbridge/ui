define(['jquery.bmsgrid','jquery.calendario','jquery.chosen','jquery.highlight','jquery-ui','text!html/campaign.html'],
function (bmsgrid,calendraio,chosen,jqhighlight,jqueryui,template) {
        'use strict';
