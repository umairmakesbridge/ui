define(['text!onetooneemails/html/singlelisting_row.html','onetooneemails/singleemaillisting'],
function (template,singleSubRowView) {
        /////////////////////////////////////////////////////////////////////////////////////////////////////////
        //
		 ...
		 var dialog = email_obj.app.showDialog({title: 'Send Messages' ,
		  ...
		  this.dialogView = dialog;
            ...
            showSingleContactMessages :  function(){
                 ...
                 var html = $('<div id="oto-single-wrapper"><div class="bmsgrid"><div class="hDiv"><div class="hDivBox campaings-hDiv"><table cellspacing="0" cellpadding="0"></table></div></div><div style="height: " class="bDiv"><div class="contacttitle"> <i class="icon contact left"></i> <a class="contactnm showtooltip" data-original-title="Click to view profile"><strong>'+this.sub_name+'</strong></a> <a class="statusdd color2 salestatus"></a></div><div class="bmsgrid" id="records-found" style="margin-left: 5px;"><strong class="badge">'+email_obj.returnDataValue.data.models.length+'</strong>  <span>Messages Sent</span></div><table cellpadding="0" cellspacing="0" width="100%" id="camp_list_contactemail"><tbody></tbody></table><div style="display: none;" class="iDiv"></div></div></div></div>');
