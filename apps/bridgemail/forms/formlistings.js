define(['jquery.bmsgrid', 'jquery.highlight', 'jquery.searchcontrol', 'text!forms/html/formlistings.html', 'bms-filters', 'daterangepicker', 'moment', 'forms/collections/formlistings', 'forms/formlistings_row'],
        function (bmsgrid, jqhighlight, jsearchcontrol, template, bmsfilters, _daterangepicker, moment, formsCollection, formsRowView) {
            'use strict';
              ...
              */
                ...
                getallemails: function (fcount, filterObj) {
                    ...
                    if (!fcount) {
                        ...
                        this.$("#camp_list_grid tbody").append('<tr class="loading-campagins"><td colspan="6"><div class="loadmore"><img src="img/loading.gif" alt=""/><p>Please wait, loading more forms.</p></div></td></tr>');
                    }
                   ...
                   // _data['status'] = this.status;
                    ...
                    this.campaigns_request = this.formsCollection.fetch({data: _data,
                        success: _.bind(function (data1, collection) {
                            ...
                            _.each(data1.models, _.bind(function (model) {
                                this.$el.find('#camp_list_grid tbody').append(new formsRowView({model: model, sub: this}).el);
                            }, this));
                            /*-----Remove loading------*/
                            ...
                            if (this.offsetLength == 0) {
                                ...
                                this.$('#total_templates').html('<p class="notfound nf_overwrite">No Forms found' + search_message + '</p>');
                                this.$el.find('#camp_list_grid tbody').before('<p class="notfound">No Forms found' + search_message + '</p>');
                            }
                ...
                showTotalCount: function (count) {
                    ...
                    var _text = parseInt(count) <= "1" ? "Form" : "Forms";
                ...
                headBadge: function () {
                    ...
                    $.post(URL, {type: 'getSummary'})
                            .done(_.bind(function (data) {
                                ...
                                stats += '<li search="Sent" class="'+sentClass+' '+ this.app.getClickableClass(allStats['sentCount']) +'" data-original-title="Click to view sent forms"><span class="badge pclr18  stattype topbadges" tabindex="-1" search="Sent" >' + allStats['sentCount'] + '</span>Sent</li>';
                                stats += '<li search="Opened" class="'+openCount+' '+ this.app.getClickableClass(allStats['openCount']) +'" data-original-title="Click to view open forms"><span class="badge pclr2 showtooltip stattype topbadges" tabindex="-1" search="Opened" >' + allStats['openCount'] + '</span>Open</li>';
                                stats += '</ul>';
