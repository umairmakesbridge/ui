                    ...
                    this._request = this.myImportsRequest.fetch({
                      success: _.bind(function (collection, response) {                                                        
                           if(collection.length){                               
                            var myimports_html = '<div class="create_new"><span>Enter salesforce import name</span></div><table cellpadding="0" cellspacing="0" width="100%" id="myimports_list_grid_salesforce"><tbody>';                                
