                              ...
                              myimports_html += '<tr id="row_'+val.get("tId")+'">';    
                                ...
                                myimports_html += '<td>';
                                    if(val.get("status")=='S'){
                                        ...
                                        myimports_html += '<div class="sched show" data-original-title='+daysDisplay+'><strong><span><em><b>'+this.getFrequency(val.get("frequency"))+'</b></em>'+daysDisplay+'</span></strong></div>';                                    
