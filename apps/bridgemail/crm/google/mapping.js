define(['text!crm/google/html/mapping.html','bms-mapping','jquery.bmsgrid','jquery.searchcontrol','jquery.highlight'],
function (template,Mapping) {
        ...
        return Backbone.View.extend({                
                ...
                render: function () {
                    ...
                    var URL = "/pms/io/google/getData/?BMS_REQ_TK="+this.app.get('bms_token')+"&type=importFields";
                    jQuery.getJSON(URL,  function(tsv, state, xhr){
                        ...
                        if(self.app.checkError(import_fields)){
                         ...
                         if(import_fields[0]!=="err"){
                            if(import_fields.count!="0"){
                                ...
                                $.each(import_fields.fldList[0], function(index, val) {                                              
                                   system_flag = val[0].defaultSetup=="Y"?"system":""; 
                                     ...
                                     fields_html += '<td><div class="name-type colico"> <strong id="google_mapping"><span><em>Google Field</em><a><b>'+val[0].label+'</b></a></span></strong> </div></td>';                                                                             
                            ...
                            URL = "/pms/io/google/setup/?BMS_REQ_TK="+self.app.get('bms_token')+"&type=getFields";
                   ...
                   this.$("#customer-mapping-search").searchcontrol({
                        ...
                        width:'250px',
                        height:'22px',
                        placeholder: 'Search Google Mapping Field',
                ...
                saveCall:function(){
                    ...
                    var URL = "/pms/io/google/setup/?BMS_REQ_TK="+this.app.get('bms_token');
