define(['text!crm/netsuite/html/setup_step.html','jquery-ui'],
function (template,crm_filters) {
        ...
        return Backbone.View.extend({                                
                ...
                initControl:function(){
                   ...
                   require(["crm/netsuite/login"],_.bind(function(page){    
                   ...
                   var nf = this.app.getAppData("netsuite");                   
                   if(nf && nf.isNetsuiteUser=="Y"){
                        this.loadMapping();                        
                   }                                       
                ...
                loadMapping:function(){
                   if(this.mappingLoaded ==false){ 
                        ...
                        this.parent.netsuiteSetup = true;                        
                       /*Load mapping view for Netsuite*/
                        ...
                        require(["crm/netsuite/mapping"],_.bind(function(page){    
