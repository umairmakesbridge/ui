define(['jquery', 'backbone', 'app', 'views/common/header', 'text!templates/main_container.html', 'views/common/footer', 'views/workspace', 'jquery.isotope'],
        function ($, Backbone, app, HeaderView, LandingPage, FooterView, WorkSpace) {
            ...
            return Backbone.View.extend({
                ...
                openSubscriber: function (sub_id,sub_name,isSupress,isSalesforceUser,rowtemplate) {
                    ...
                    this.addWorkSpace({type: '',
                        ...
                        params: {sub_id: sub_id,sub_name:sub_name,isSalesforceUser:isSalesforceUser,editable:isEditable,email:email,rowtemplate:rowtemplate},
                        actions: []
                    });
                },
                ...
                showPopup: function (e) {
                    ...
                    var _arr = {"_liveChat": {title: "Live Chat", cssClass: 'livechatdialog', url: "https://server.iad.liveperson.net/hc/69791877/?cmd=file&file=visitorWantsToChat&site=69791877&byhref=1&imageUrl=https://server.iad.liveperson.net/hcp/Gallery/ChatButton-Gallery/English/General/1a/"},
                        "_knowledgeBase": {title: "Knowledgebase", cssClass: 'knowledgebasedialog', url: " https://makesbridge.crisp.help/en-us/"},
                        "_videoGallery": {title: "Video Gallery", cssClass: 'videoGallery', url: "https://www.makesbridge.com/video-guides/"},
                        "_youtubechannel": {title: "Youtube Channel", cssClass: 'youtubechannel', url: "https://www.youtube.com/user/makesbridge/featured"},
                ...
                one_one_listings : function(){
                 ...
                 tipandtestlistings : function(){
                   this.addWorkSpace({type: '', noTags: true ,title: 'Playbooks', sub_title: 'Listings', url: 'tipandtest/tipandtestlisting', workspace_id: 'tiptest_listings', 'addAction': false, tab_icon: 'tipntestlisting'}); 
                },
                tip_test : function(){
