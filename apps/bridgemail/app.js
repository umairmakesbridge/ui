...
define([
    ...
    var App = Backbone.Model.extend({        
        ...
        initialize: function () {
            ...
            this.testUsers = ['admin', 'jayadams', 'demo', 'MKS-Training2', 'mansoor@makesbridge.com','umair'];
        ...
        fixEmailFrom: function () {
            ...
            active_workspace.find('#campaign_from_email_chosen').css({"width": parseInt(subj_w + 41) + "px","margin-right":"40px"});   // Abdullah Try
