...
!function ($) {
  ...
  , init: function (element, options) {           
     ...
     this.$element.on("drop",$.proxy(this._drop,this))      
      ...
      this.$element.on('dragstart',$.proxy(this._dragstart,this))
      this.$element.on('dragend',$.proxy(this._dragend,this))
    ...
    _dragstart : function(e){
            this.isSameElement = true;
            var dragged = e.target;
            this.$element.find('.dropblockpanel').hide();
  ...
  _dragenter:function(e){
    ...
    if(!this.isSameElement){
      ...
      this.$element.find(".dropblockpanel").parent().height();
                                    var _height = this.$element.find(".dropblockpanel").parent().height() - 30;
                                    var _scrollTop = this.$element.parent().scrollTop();
                                    this.$element.find(".dropblockpanel").show().css({
                                        "top": _scrollTop + "px",
                                        "height": _height + "px"
                                    });
       //this.$element.find('.dropblockpanel').show();  
    }else{
        this.$element.removeClass('file-border');
    }
  ...
  * ========================= */
  ...
  $.fn.dragfileEditor = function ( option ) {
  ...
  $.fn.dragfileEditor.Constructor = Dragfile

  $.fn.dragfileEditor.defaults = {    
    app:null,
    post_url:'',
    from:'',
